    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center space-x-2">
                <span class="w-3 h-3 rounded-full {{ $modelHealth === 'healthy' ? 'bg-green-500' : 'bg-red-500' }}"></span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="flex gap-2 mb-4">
                    ...
                    <button wire:click="testClassification" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm">
                        Classify
                    </button>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="flex flex-wrap gap-1 mt-2">
                    @foreach($seasonalRisks['active_risks'] ?? [] as $risk)
                        <span class="px-2 py-0.5 bg-orange-100 text-orange-700 text-xs rounded-full">{{ $risk }}</span>
                    @endforeach
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 lg:col-span-2">
                ...
                <div class="flex gap-2">
                    ...
                    <button wire:click="sendMessageToModel" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 text-sm">
                        Send
                    </button>
                </div>
            </div>
